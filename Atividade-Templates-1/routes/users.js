...
router.get('/:userid', function (req, res, next) {
  ...
  if (userid !== 'signin' && userid !== 'signup') {
    res.render('users', { title: userid , content: "Seja bem-vindo " + userid});
    ...
    if (userid === 'signin') {
      ...
      console.log('Usuário entrou em users/signin')
        ...
        res.render('signup', { title: 'Sign Up' , content: "No link, coloque um nome junto do users. Por exemplo <b>/users/José Maia</b>, a estrutura é <b>http://localhost:PORTA/users/NOME</b>"});
        res.send
